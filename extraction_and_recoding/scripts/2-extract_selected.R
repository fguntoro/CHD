...
codings <- fread("../docs/Codings.txt", data.table = FALSE) # Codings for categorical outcomes: https://biobank.ctsu.ox.ac.uk/crystal/exinfo.cgi?src=accessing_data_guide
...
choices[which(is.na(choices$FigureName)),"FigureName"] = choices[which(is.na(choices$FigureName)),]$Field
